...
$RemGroups = (Get-ADUser "$TargetUser" -prop MemberOf).MemberOf -notmatch 'M365_License_Exchange' -notmatch 'M365_License_OneDrive' -notmatch 'Okta VDI' -notmatch 'Okta VPN' -notmatch 'Domain Users' -notmatch 'EXCH_NO_OWA' -notmatch 'O365_MFA_Required'  
